...
{ 
	...
	{ 		
        ...
        /// <returns></returns>
        public string RSADecryptEx(string xmlPrivateKey, string m_strDecryptString)
        {
            byte[] PlainTextBArray;
            byte[] DypherTextBArray;
            string Result;
            ...
            using (MemoryStream output = new MemoryStream())
            {
                ...
                DypherTextBArray = output.ToArray();
        ...
        public bool SignatureFormatter(AsymmetricAlgorithm PrivateKey, string m_strHashbyteSignature, ref string m_strEncryptedSignatureData)
        {
            ...
            //HashbyteSignature = Encoding.UTF8.GetBytes(m_strHashbyteSignature);

            //System.Security.Cryptography.RSACryptoServiceProvider RSA = new System.Security.Cryptography.RSACryptoServiceProvider();
            RSACryptoServiceProvider RSA = (RSACryptoServiceProvider)PrivateKey;
            //RSA.FromXmlString(p_strKeyPrivate);
            System.Security.Cryptography.RSAPKCS1SignatureFormatter RSAFormatter = new System.Security.Cryptography.RSAPKCS1SignatureFormatter(RSA);
            //设置签名的算法为MD5 SHA1WithRSA
            RSAFormatter.SetHashAlgorithm("SHA1");
            //执行签名 
            //SHA1CryptoServiceProvider hashalg = new SHA1CryptoServiceProvider();
            //EncryptedSignatureData = RSA.SignData(HashbyteSignature, hashalg);
            EncryptedSignatureData = RSAFormatter.CreateSignature(HashbyteSignature);
        ...
        public bool SignatureDeformatterSHA1(string p_strKeyPublic, string p_strHashbyteDeformatter, string p_strDeformatterData)
        {

...
namespace XYcms.Common
{
    public class Util
    {
        ...
        public static string GetUrlHtml(string url, string Encode = "utf-8", string Method = "GET", string PostData="")
        {
        ...
        public static string PostWebApiUrlHtml(string url, string Encode = "utf-8", string PostData = "")
        {
            HttpHelper httphelper = new HttpHelper();
            HttpItem item = new HttpItem()
            {

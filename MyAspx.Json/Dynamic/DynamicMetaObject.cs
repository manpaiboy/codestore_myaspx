...
using MyAspx.Json.Dynamic;

namespace MyAspx.Json.Dynamic
{
    ...
    {
        // warning CS0649: Field 'Maticsoft.Dynamic.Option<T>.None' is never assigned to, and will always have its default value 
...
namespace XM.Json.Dynamic
{
    ...
    internal sealed class DynamicMetaObject<T> : DynamicMetaObject
    {
        ...
        public override DynamicMetaObject BindInvokeMember(InvokeMemberBinder binder, DynamicMetaObject[] args)
        {
            ...
            // >>> require 'XM.Json'
            // => true
            // >>> o = Maticsoft::Json::JsonObject.new
            // => {}
            // >>> o.foo = 123
            // => 123
            // >>> o.foo
            // (ir):1: undefined method `foo' for {"foo":123}:Maticsoft::Json::JsonObject (NoMethodError)
        }

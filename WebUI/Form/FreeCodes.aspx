...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item" id="speli"><SPAN class="labelinfo">源码类型:</SPAN>
                      <span class="label label-default">企业网站</span>  <span class="label label-default">新闻文章</span>  <span class="label label-default">博客空间</span>  <span class="label label-default">影音娱乐</span>  <span class="label label-default">上传下载</span>  <span class="label label-default">留言本类</span>  <span class="label label-default">投票调查</span>  <span class="label label-default">聊天计数</span>  <span class="label label-default">尚未分类</span>  <span class="label label-default">电子商务</span>  <span class="label label-default">控件应用</span>  <span class="label label-default">新知实践</span>  <span class="label label-default">商务办公</span> <span class="label label-default">会员交友</span>  <span class="label label-default">论坛社区</span>  <span class="label label-default">学教实践</span>  <span class="label label-default">企业办公</span><div> <span class="label label-default">网络应用</span>  <span class="label label-default">开发辅助</span>  <span class="label label-default">仓储物流</span>  <span class="label label-default">游戏娱乐</span>  <span class="label label-default">酒店餐饮</span>  <span class="label label-default">门户综合</span>  <span class="label label-default">行业软件</span>  <span class="label label-default">系统工具</span>  <span class="label label-default">实验作品</span>  <span class="label label-default">其他类别</span></div> 
                </li>
              </ul>
            </div>
        </div>
